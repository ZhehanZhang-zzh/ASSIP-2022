...
# This sample executes a search request for the specified category.
#
...
def youtube_search(options):
    ...
    file_name_videos = '/CIL_YT/peopleblog.json'
    #file_name_channels = '/CIL_YT/beauty_channels.json'

    import os
    
    # check if size of file is 0
    with open(file_name_videos, 'a') as f:
       json_object = json.dumps(res, indent = 4)
       z = json.loads(json_object)
       json.dump(z, f, indent = 4)
    
    # with open(file_name_channels, 'a') as f:
